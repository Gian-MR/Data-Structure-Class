...
public class RemoveValuesWrapper {

    public static interface List<E> extends Iterable<E> {
        public void add(E elm);

        int removeValues(List<E> valueList);
    ...
    public static class DoublyLinkedList<E> implements List<E> {
        ...
        private class Node<E> {
            // References the node that goes after this one. (This is the previous node of
            // next)
            private Node<E> next;
            // References the node that goes before this one. (This is the next node of
            // prev)
            private Node<E> prev;
         ...
         * 
         * The format will be: { header <-> A <-> B <-> C <-> trailer }, where each
         * element within the brackets { }
         * represent the current data of the nodes in the List. Example: A represents
         * the node with
         * the value A and -> represents what A is pointing to, in this case, the node
         * with element B.
         * Since the next of the last element of the SinglyLinkedList if null we end the
        ...
        @Override
        public int removeValues(List<E> valueList) {
            /* ADD YOUR CODE HERE */
            int removed = 0;
            ...
            while (curr != trailer) {
                ...
                if (valueList.contains(curr.getElement())) {
                    curr.getPrev().setNext(curr.getNext());
                    curr.getNext().setPrev(curr.getPrev());
                    curr.clear();
                    size--;
