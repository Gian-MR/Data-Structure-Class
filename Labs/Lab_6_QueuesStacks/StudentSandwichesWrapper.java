...
public class StudentSandwichesWrapper {
     ...
     * Where sandwiches[i] is the type of the i​​​​​​th sandwich in the stack (i = 0
    ...
    public static int countStudents(int[] students, int[] sandwiches) {
        int failedCount = 0;
        Queue<Integer> Stud = new DoublyLinkedQueue<>();
        Stack<Integer> SandW = new SinglyLinkedStack<>();
        ...
        while(failedCount != Stud.size() && !Stud.isEmpty() && !SandW.isEmpty()){
            if(Stud.getFront().equals(SandW.top())){
                Stud.dequeue();
                SandW.pop();
                failedCount = 0;
            } else {
